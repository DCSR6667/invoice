...
app.set('views','views');
app.use('/',express.static('/invoice/static'));
app.use('/',express.static('/invoice/payslips'));
app.use('/',express.static('/invoice/invoices'));
...
app.post('/sheet_invoices_submit',(req,res,next)=>
{
    ...
    var path="/invoice/"+req.files.invoice[0].path;
...
app.get('/generate_invoices/:data',async(req,res,next)=>
{
    ...
    var p='/invoice/invoices/'+foldername;
   ...
   for(var i of data)
    {
        ...
        try{
            ...
            const pdfn=await page.pdf({
                path:'/invoice/invoices/'+foldername+'/'+filename,           
...
app.post('/sheet_payslips_submit',(req,res,next)=>
{
    ...
    var path="/invoice/"+req.files.upload[0].path;
...
app.get('/generate_payslips/:data',async(req,res,next)=>
{
    ...
    var p='/invoice/payslips/'+foldername;
   ...
   for(var i of data)
    {
        ...
        try{
            ...
            const pdfn=await page.pdf({
                path:'/invoice/payslips/'+foldername+'/'+filename,
                printBackground:true,
                format:"A4"
            });
            var url='/'+foldername+'/'+filename;
